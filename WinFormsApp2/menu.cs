    ...
    public partial class menu : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (priceset)
            {
                ...
                if (rightarmy.Count > 0 && leftarmy.Count > 0) form1.ShowDialog();
                this.Close();
            }
        }
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            if (comboBox4.SelectedIndex > -1)
            {
                ...
                leftarmy.Remove(comboBox4.SelectedIndex);
                comboBox4.Text = " ";
        ...
        {
            if (priceset && customize && comboBox1.SelectedIndex > -1 && rightarmy.Count<13)
            {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            if (comboBox3.SelectedIndex > -1)
            {
                ...
                rightarmy.Remove(comboBox3.SelectedIndex);
                comboBox4.Text = " ";
